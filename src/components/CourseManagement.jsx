...
const CourseManagement = () => {
  const [courses, setCourses] = useState([
    ...
    },
    {
      ...
      description: 'Complete guide to building scalable backend applications with Node.js and Express.',
      duration: '10 weeks',
      ...
      <Card className="bg-white shadow-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <label className="text-sm font-medium">Update Course Team Size</label>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              ...
              <Button onClick={handleUpdateTeamSize} className="bg-green-600 hover:bg-green-700">
